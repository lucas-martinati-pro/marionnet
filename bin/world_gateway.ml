...
module Make_menus (Params : sig
  ...
  module Properties = struct
    ...
    let dynlist () = st#network#get_node_names_that_can_modify ~devkind:`World_gateway ()
  ...
  module Remove = struct
    ...
    let dynlist () = st#network#get_node_names_that_can_destroy ~devkind:`World_gateway ()
