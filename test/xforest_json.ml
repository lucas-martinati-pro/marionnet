...
(* The independent UTF-8 validator: written in test/utf_8_reference.ml, NOT the one the
   codec uses to decide whether a string needs the base64 fallback - checking the output of
   a codec with the very predicate that drives it would be circular (see the header of that
   file, and section 8.4 of docs/migration-marshal-to-text.md). *)
