...
module User_level_machine : sig
  ...
  class machine :
    ...
    object ('c)
      val id      : int
      val network : User_level.network
      val mutex   : User_level.Recursive_mutex.t
      (* --- *)
      val mutable name       : string
      val mutable label      : string
      val mutable memory     : int
      val mutable ports_card : 'c User_level.ports_card option
      ...
      val mutable rc_config  : bool * string
      val mutable terminal   : string
      val mutable console_no : int
      (* --- *)
      method id                           : int
      method name                         : string
      ...
      method ports_card  : 'c User_level.ports_card
